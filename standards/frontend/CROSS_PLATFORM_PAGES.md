...
import { provideContentManager, ContentPageLayout } from '@kael/ui'
...
<script setup lang="ts">
import { ServersManageContentPage } from '@kael/ui'
</script>
...
```ts
import { injectModrinthClient, injectModrinthServerContext, ServersManageFilesPage } from '@kael/ui'
