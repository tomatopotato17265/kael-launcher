...
import type { Paper } from '@kael/api-client'
import { EyeIcon, EyeOffIcon, UploadIcon, XIcon } from '@kael/assets'
import { commonMessages, defineMessages, useVIntl } from '@kael/ui'
