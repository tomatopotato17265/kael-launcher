...
import { CalendarIcon, XIcon } from '@kael/assets'
import chevronLeftIcon from '@kael/assets/icons/chevron-left.svg?raw'
import chevronRightIcon from '@kael/assets/icons/chevron-right.svg?raw'
