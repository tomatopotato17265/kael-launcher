...
import { CalendarIcon, DownloadIcon, getLoaderIcon, PlusIcon, StarIcon } from '@kael/assets'
import {
	AutoLink,
	ButtonStyled,
	FormattedTag,
...
import { formatVersionsForDisplay, type GameVersionTag, type Version } from '@kael/utils'
