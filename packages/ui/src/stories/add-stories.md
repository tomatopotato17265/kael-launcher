...
This document provides instructions for AI assistants when creating Storybook stories for Vue components in the `@kael/ui` package.
...
Import icons from `@kael/assets`:

```typescript
import { SearchIcon, ChevronDownIcon } from '@kael/assets'
