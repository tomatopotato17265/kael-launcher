			...
			<div class="flex flex-col gap-4 w-full min-h-[20rem]">
				<section v-if="mode === 'edit' && canEditTextureAndModel">
					...
					<div class="flex flex-wrap gap-2">
						...
						<ButtonStyled>
							<button class="!shadow-none" @click="openInEditor">
								<EditIcon /> {{ formatMessage(messages.editTextureButton) }}
							</button>
						</ButtonStyled>
					</div>
					<input
...
import { CheckIcon, EditIcon, SaveIcon, SpinnerIcon, UploadIcon, XIcon } from '@kael/assets'
import {
	ButtonStyled,
	CapeButton,
	CapeLikeTextButton,
