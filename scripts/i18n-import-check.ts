...
// i18n symbols that should be imported from @kael/ui
...
const VALID_IMPORT_SOURCES = ['@kael/ui']
...
function main() {
	...
	if (verbose) {
		console.log(theme.muted('  Tip: Import these symbols from @kael/ui'))
		console.log(theme.muted('  Example: import { useVIntl, defineMessages } from \'@kael/ui\''))
		console.log()
	}
